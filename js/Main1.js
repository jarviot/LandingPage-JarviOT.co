...
var themes = [ [ "#4e0102", "#9a0408", "#d30409", "#FFFFFF", "#fc4348" ],
	 ];
var theme;
...
function createInstructions() {
	...
	text.innerHTML = '<span style="color:' + theme[0] + ';font-size:35px;">Thank You</span><br /><br /><span style="font-size:15px;"><strong>Sucessfully</strong><br />Your Mail Has Been Sent</span>';
